...
export const MILESTONE_REWARDS: { [milestone: number]: Reward } = {
  ...
  25: {
    ...
    description: "Dernier refuge sous un ciel étoilé avant l'étape finale. Vous avez prouvé que vous étiez une personne unique et audacieuse.",
    image: "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=800&q=80",
    quote: "« Le hasard fait bien les choses, mais un petit coup de pouce du destin change parfois une vie. »",
    rewardText: "Promesse n°5 (Ultime) : Le déblocage direct de mon numéro (06 51 33 22 09) en fin de parcours avec le code secret unique à m'envoyer par SMS !"
  }
};
