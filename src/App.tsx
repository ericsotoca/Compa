      ...
      <header className="relative z-10 w-full max-w-2xl mx-auto flex justify-between items-center mb-6">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="p-2 rounded-full bg-white border border-[#eae1dc] text-[#5c4d4a] hover:bg-rose-50 hover:text-[#c85a53] transition-all cursor-pointer shadow-2xs"
        ...
        {gameState === "playing" && (() => {
          ...
          return (
            <div 
              ...
              className="w-full bg-white border border-[#eae1dc] rounded-2xl shadow-sm flex flex-col overflow-hidden animate-slide-up" 
              id="panel-gameplay"
            >
              {/* Liseré de couleur dynamique par question */}
              <div className={`h-1.5 w-full bg-gradient-to-r ${lisereGradient}`} />
              ...
              <div className="pt-4 border-t border-[#eae1dc]/50 text-center">
